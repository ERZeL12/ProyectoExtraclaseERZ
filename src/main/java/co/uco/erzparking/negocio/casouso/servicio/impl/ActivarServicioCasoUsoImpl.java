...
public class ActivarServicioCasoUsoImpl implements ActivarServicioCasoUso {

	private DAOFactory daoFactory;

	public ActivarServicioCasoUsoImpl(final DAOFactory daoFactory) {
		super();
	...
	private void activar(final UUID id) {
		daoFactory.getServicioDAO().cambiarEstadoActual(id, true);
	}
